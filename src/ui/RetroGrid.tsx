  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-ink">
      ...
      <div className="absolute left-1/2 top-[14%] h-[440px] w-[440px] -translate-x-1/2">
        <div className="animate-pulse-orb h-full w-full rounded-full bg-[radial-gradient(circle,rgba(232,121,249,0.45)_0%,rgba(139,92,246,0.2)_42%,transparent_72%)] blur-[90px]" />
      </div>
